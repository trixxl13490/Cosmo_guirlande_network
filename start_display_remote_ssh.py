...
try:
    ...
    stdin3.write('''
      export XAUTHORITY=/home/pi/.Xauthority
      DISPLAY=:0  /usr/bin/lxterm -e 'sudo python3 /home/pi/Cosmo_guirlande_network/gui_rpi.py 3 91 192.168.0.20 50003 1024 RGB'
      ''')
    print("ss3 passed")
except socket.timeout:
    print("ss3 timeout")
...
try:
    ...
    ssh4.connect(hostname='192.168.0.16', username='pi', password='vbcgxb270694', timeout=5, port=22)
